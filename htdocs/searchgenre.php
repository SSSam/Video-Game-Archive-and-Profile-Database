...
cellspacing=\"2\" cellpadding=\"0\"><tr align=\"center\" >";
$i = 0;
while ($i < mysqli_num_fields($rsResult)){
    $field = mysqli_fetch_field_direct($rsResult, $i);
    $fieldName=$field->name;
    echo "<th><strong>$fieldName</strong></td>";
    $i = $i + 1;
    }
    echo "</tr>";
...
$genre_cols = $_POST["genre_type"];
$conn = OpenCon();
$sql = "SELECT $att_cols 
FROM genre, game, part_of
WHERE genre.Genre_Type = '$genre_cols'
AND part_of.Genre_id= genre.Genre_id
